...
namespace Project18_DashboardSuperStore
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection sqlConnection = new SqlConnection("Server=DESKTOP-FDKFGC2;initial catalog=Db17Project20;integrated security=true");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            while (reader3.Read())
            {
                lblCountByCountry.Text = reader3[0].ToString();
            }
            sqlConnection.Close();
            sqlConnection.Open();
