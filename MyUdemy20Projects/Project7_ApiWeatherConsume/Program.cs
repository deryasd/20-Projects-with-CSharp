...
if (number == "1")
{
    string url = "https://localhost:7057/api/Weathers";
...
if (number == "2")
{
    ...
    using (HttpClient client = new HttpClient()) {
        ...
        foreach(var item in jArray)
        {
            string citynName = item["cityName"].ToString();
            string temp = item["temp"].ToString();
            string country = item["country"].ToString();
            Console.WriteLine(citynName + "-" + country + "-->" + temp + " Derece");
            Console.WriteLine("--------------------------------");
        }
    }
}
...
if (number == "4")
{
    string url = "https://localhost:7057/api/Weathers?id=";
...
if (number == "6")
{
    string url = "https://localhost:7057/api/Weathers/GetByIdWeatherCity?id=";
